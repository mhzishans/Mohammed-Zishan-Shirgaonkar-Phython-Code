...
print("251A015", "04|02|26\n")

CET = {"251A034", "251A035", "251A036"}
JEE = {'251A034', '251A050', '251A049', '251A060'}
NEET = {'251A022', '251A024', '251A002'}

print(CET | JEE | NEET)   # total students

print("Total students appeared in the exams:", CET | JEE | NEET)   # total no. of students
...
print(CET | JEE)   # total students appeared in cet and jee
